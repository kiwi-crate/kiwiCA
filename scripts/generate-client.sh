...
openssl genpkey -algorithm RSA                                  \
                ...
                -aes256                                         \
                -out /opt/ca-crate/private/${CLIENT_NAME}.key   \
                -pass file:${CLIENT_MOUNT_LOCATION}/client_pkey_password;
chmod 400 /opt/ca-crate/private/${CLIENT_NAME}.key

echo "Generating Client CSR...";
openssl req -new                                                        \
            -subj ${CLIENT_CRT_SUBJECT}                                 \
            -key /opt/ca-crate/private/${CLIENT_NAME}.key               \
            -passin file:${CLIENT_MOUNT_LOCATION}/client_pkey_password  \
            -out /opt/ca-crate/CSRs/${CLIENT_NAME}.csr;
...
openssl ca -extensions ${CLIENT_TYPE}_certificate                   \
           ...
           -in /opt/ca-crate/CSRs/${CLIENT_NAME}.csr                     \
           -out /opt/ca-crate/certs/${CLIENT_NAME}.pem;
chmod 444 /opt/ca-crate/certs/${CLIENT_NAME}.pem
